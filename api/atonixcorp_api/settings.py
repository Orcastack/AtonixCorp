...
if not DEBUG:
    if EMAIL_BACKEND != 'django.core.mail.backends.smtp.EmailBackend':
        raise RuntimeError('Production email delivery requires the Django SMTP email backend.')
    if not EMAIL_HOST or not EMAIL_HOST_USER or not EMAIL_HOST_PASSWORD:
        raise RuntimeError('Production SMTP delivery requires EMAIL_HOST, EMAIL_HOST_USER, and EMAIL_HOST_PASSWORD.')
