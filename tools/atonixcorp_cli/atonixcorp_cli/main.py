...
from .api import DEFAULT_HOST, AtonixCorpClient, expires_at_from_now
...
def _authenticated_client_session(profile_name=None):
    ...
    client = AtonixCorpClient(session['host'])
...
def command_login(args):
    ...
    client = AtonixCorpClient(args.host or DEFAULT_HOST)
